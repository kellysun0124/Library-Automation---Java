    ...
    public static initialize() {
        try {
            ...
            if(members.exists()) {
                ...
                while(String curr = reader.readLine() != null) {
                    String[] memberInfo = curr.split("\t");
                    String memID = memberInfo[0].strip();
                    ...
                    Date newdob = convertTextFieldToDate(origDob);
                    Member mem = new Member(name, address, newdob, email, curr, memberType, memberType);
                    memberlist.add(mem);
                }
